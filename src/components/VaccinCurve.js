...
export default function VaccinCurve() {
    ...
    const [dethes , setDethes] = React.useState(null);
    const [vaccin , setVaccins] = React.useState(null);
    ...
    const fetchData = async()=>{
      try{
        ...
        setRec(reponse.data.recovred);
        setDethes(reponse.data.dethes);
        setVaccins(reponse.data.vaccin);
      }catch(e){
        console.log(e);
      }
    }
